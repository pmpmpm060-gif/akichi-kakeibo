...
const guides: Record<string, ScreenGuide> = {
  '/': {
    ...
    steps: [
      ...
      '家計アラートで、予算超過や前月より増えた支出を確認します。確認後は右端の削除ボタンで消せます。',
  ...
  '/dashboard': {
    ...
    steps: [
      '日付・分類・金額・メモに加えて、タグとレシート画像も登録できます。',
  ...
  '/reports': {
    ...
    steps: [
      ...
      'AI家計診断では、集計値だけを使った改善提案を実行し、過去の診断結果も確認できます。',
      '年間では年間収支・月平均・年間ランキングを確認できます。',
      'タグ別支出を確認し、月ごとの振り返りメモを保存できます。',
    ],
    tip: 'AI診断へ取引メモやレシート画像は送られないぶー！',
  },
  '/savings': {
    title: '貯金目標画面の使い方',
  ...
  '/login': {
    ...
    steps: [
      ...
      'パスワードを入力します。',
      '「ログインする」を押します。',
      '初めて使う場合はメールアドレスと6文字以上のパスワードを入力し、「新しく利用登録する」を押します。',
